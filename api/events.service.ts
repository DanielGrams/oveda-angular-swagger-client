...
export class EventsService {
     ...
     */
    public apiV1EventsGet(page?: number, perPage?: number, observe?: 'body', reportProgress?: boolean): Observable<EventListResponse>;
    public apiV1EventsGet(page?: number, perPage?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<EventListResponse>>;
    public apiV1EventsGet(page?: number, perPage?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<EventListResponse>>;
    public apiV1EventsGet(page?: number, perPage?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV1EventsSearchGet(page?: number, perPage?: number, keyword?: string, dateFrom?: string, dateTo?: string, coordinate?: string, distance?: number, categoryId?: Array<number>, weekday?: Array<number>, observe?: 'body', reportProgress?: boolean): Observable<EventSearchResponse>;
    public apiV1EventsSearchGet(page?: number, perPage?: number, keyword?: string, dateFrom?: string, dateTo?: string, coordinate?: string, distance?: number, categoryId?: Array<number>, weekday?: Array<number>, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<EventSearchResponse>>;
    public apiV1EventsSearchGet(page?: number, perPage?: number, keyword?: string, dateFrom?: string, dateTo?: string, coordinate?: string, distance?: number, categoryId?: Array<number>, weekday?: Array<number>, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<EventSearchResponse>>;
    public apiV1EventsSearchGet(page?: number, perPage?: number, keyword?: string, dateFrom?: string, dateTo?: string, coordinate?: string, distance?: number, categoryId?: Array<number>, weekday?: Array<number>, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
